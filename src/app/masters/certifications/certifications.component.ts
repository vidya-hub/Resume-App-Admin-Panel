...
export class CertificationsComponent implements OnInit {
  ...
  fnGetCategories() {
    ...
    this.service.post('admin/get_all_certifications', form).then((result: any) => {
      this.page++;
  ...
  fnSubmitCategory() {
    ...
    this.service.post('admin/add_certifications', form).then((result: any) => {
  ...
  fnUpdateCategory() {
    ...
    .set("expFlag",JSON.stringify(this.selectedExp))
    this.pleaseWaitBtn = true;
    this.service.post('admin/update_certifications', form).then((result: any) => {
      if (result && result.msg && result.msg != '') {
        this.toast.success(result.msg)
      }
  ...
  fnEnableCategory() {
    ...
    this.pleaseWaitBtn = true;
    this.service.post('admin/enable_certifications', form).then((result: any) => {
      if (result && result.msg && result.msg != '') {
        this.toast.success(result.msg)
      }
  ...
  fnDisableCategory() {
    let form = new HttpParams().set('id', this.selectedCategory._id)
    this.pleaseWaitBtn = true;
    this.service.post('admin/disable_certifications', form).then((result: any) => {
      if (result && result.msg && result.msg != '') {
        this.toast.success(result.msg)
      }
  ...
  fnDeleteCategory() {
    let form = new HttpParams().set('id', this.selectedCategory._id)
    this.pleaseWaitBtn = true;
    this.service.post('admin/delete_certifications', form).then((result: any) => {
      if (result && result.msg && result.msg != '') {
        this.toast.success(result.msg)
      }
