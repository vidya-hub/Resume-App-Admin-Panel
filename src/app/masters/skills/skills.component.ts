...
export class SkillsComponent implements OnInit {
  ...
  fnGetCategories() {
    ...
    this.service.post('admin/get_all_skill', form).then((result: any) => {
      this.page++;
  ...
  fnSubmitCategory() {
    ...
    this.service.post('admin/add_skill', form).then((result: any) => {
  ...
  fnUpdateCategory() {
    ...
    let form = new HttpParams().set('title', this.name).set("expFlag",JSON.stringify(this.selectedExp)).set('id', this.selectedCategory._id).set('jobtitleId',this.jobtitleId)
    this.pleaseWaitBtn = true;
    this.service.post('admin/update_skill', form).then((result: any) => {
      if (result && result.msg && result.msg != '') {
        this.toast.success(result.msg)
      }
  ...
  fnEnableCategory() {
    ...
    this.pleaseWaitBtn = true;
    this.service.post('admin/enable_skill', form).then((result: any) => {
      if (result && result.msg && result.msg != '') {
        this.toast.success(result.msg)
      }
  ...
  fnDisableCategory() {
    let form = new HttpParams().set('id', this.selectedCategory._id)
    this.pleaseWaitBtn = true;
    this.service.post('admin/disable_skill', form).then((result: any) => {
      if (result && result.msg && result.msg != '') {
        this.toast.success(result.msg)
      }
  ...
  fnDeleteCategory() {
    let form = new HttpParams().set('id', this.selectedCategory._id)
    this.pleaseWaitBtn = true;
    this.service.post('admin/delete_skill', form).then((result: any) => {
      if (result && result.msg && result.msg != '') {
        this.toast.success(result.msg)
      }
